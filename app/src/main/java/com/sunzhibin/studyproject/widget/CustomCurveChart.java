...
public class CustomCurveChart extends View {
    ...
    public void init() {
        ...
        paintTable.setColor(ContextCompat.getColor(getContext(), R.color.colorPrimaryDark));
        ...
        paintValue.setColor(ContextCompat.getColor(getContext(), R.color.ml_blue));
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawColor(ContextCompat.getColor(getContext(), R.color.ml_blue));
        init();
